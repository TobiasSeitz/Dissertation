...
\caption{\label{tbl:rw:auth_comparison}Comparison of different biometric authentication methods. Adapted from \cite{Stockinger2011ImplicitAuthentication}}
\end{table}

%TODO: add example reference, like bonneau did.