...
%TODO maybe show how the elicitation was structured. (observe, measure, ask, understand, learns)
...
It is also possible to flag passwords as ``unique'', i.e. that they do not belong to a group of accounts that share the same password. Figure \ref{fig:pwrm:entry-unique} shows the page that also visually indicates the strength of the passwords. 
...
% 5 people in paper-prototyping stage / wizard of oz study
% 7 students in click-dummy stage / wireframes
% 6 people usability test with extension (stage 1) / 4m 2f
% 18 participants in a field study over two weeks. 
...
% I showed how to use the P4P framework to answer research questions posed as future work in another paper - and even create a solution based on them. 

% pretty heavy and elaborate design exercise. A smaller example would be the design of the bandwagon meter. 
