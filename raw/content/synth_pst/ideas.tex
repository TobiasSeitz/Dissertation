\chapter[Ideas for Holistic Password Support]{Ideas}\label{chap:pst:ideas}
...
social patterns helpful: Instead of saying a password is better than 90\% of other _users_ we could frame it as ``this password lowers your chance of being attacked by XX percent'' or ``this password is better than 90\% of passwords used on the internet''. issues: it's kind of hard to really be truthful here. deceptive in some ways and that's not something we want. 
