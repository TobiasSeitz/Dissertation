...
A player's first game is vital for the assessment of their pre-existing strength perceptions in different conditions. After the first game, learning effects induced by our feedback are likely to change their subsequent judgments. Therefore, the first game is the most valuable indicator of mental models of password strength. In their first game, players achieved an average score of 2010 points (SD=653.16, Min=350, Max=3675). On average, they rated 27.21 passwords in their first game (SD=8.34), which is more than in later games, but not significantly ($t_{32}(2) = 1.13, p > 0.1, 95\%-CI = [-2.04;7.12]$).%created with JASP and file first-vs-sub-rounds-played
...
% I guess that things have not changed much afterwards, but maybe a critical phase was in November 2017 when an update was released.
% played at OzCHI, which resulted in a number of new 

%TODO maybe plot the dates when the game was played throughout the first year? sounds cool. 
