...
\fbox{
	\hspace{0.2cm}
	\parbox[c][5.5cm]{0.95\linewidth}{
		\subsection*{Publication Statement}
		Parts of the outcome of this investigation have been published as an extended abstract at SOUPS 2017 \cite{Prinz2017MentalModel}. For the most part, the chapter picks up the content of that paper and puts it into the larger context of this thesis. There are two significant additions:
		\begin{itemize}[leftmargin=*]
			\item The chapter includes the detailed structure of the mental model
			\item The chapter elaborates on the design of a value proposition for password managers that takes users' mental models into account.
		\end{itemize}
	}
	\hspace{0.2cm}
}
