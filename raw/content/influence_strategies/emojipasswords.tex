...
\fbox{
	...
	\parbox[c][12cm]{0.7\linewidth}{
		...
		\begin{itemize}[leftmargin=*]
			...
			\item Simulating log-ins on a different platform than where the emoji-password was selected resulted in notable troubles, because users fail to recognize previously selected emojis.
			\item A point-and-click interface works for emoji-passwords, but emojis must be reduced to a small sample and not look very similar to each other. 
