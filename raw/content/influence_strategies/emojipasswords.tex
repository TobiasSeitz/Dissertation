...
% everyone uses emojis already. 
% the picture superiority effect might be helpful to make emoji passwords very memorable.
...
% but: unique project: hybrid between alphanumeric knowledge-based passwords and 
