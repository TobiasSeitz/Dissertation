...
\fbox{
	...
	\parbox[c][8cm]{0.7\linewidth}{
		...
		\begin{itemize}[leftmargin=*]
			...
			\item Demonstrating that strong passwords do not have to be overly complicated by suggesting and a passphrase seems made our participants select stronger passwords. Using feed-forward appears to encourage people to come up with a better secret. %However, this needs to be confirmed in another study. 
		\end{itemize}
	}
	\hspace{1cm}
}
