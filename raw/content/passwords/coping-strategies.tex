...
%Usable security shouldn't only be done for end users but also for the people who implement security systems \cite{Acar2016NotYourDeveloper}
	...
	password strength perceptions probably derived from policies \cite{Ur2016PerceptionsPassword}
	...
	misinterpreted security advice.	this is also reflected in \cite{Ur2016PerceptionsPassword}
	...
	We can give better recommendations to users that are appropriately secure, actionable and usable \cite{ZhangKennedy2016RevisitingPasswordRules} 
	...
	% Foundations of Persuasion -- small excursus
