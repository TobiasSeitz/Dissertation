...
%	Graphics as additional layer \cite{Gao2010ColorLogin} \cite{DeLuca2010ColorPIN}
	...
	% Combining multiple features as the most promising solution in terms of accuracy:
	combining audio and images as early as 1995 \cite{Brunelli1995PersonIdentificationMultipleCues}
	\cite{Rybnicek2014RoadmapContinuousAuth}
	in 2005 \cite{Bigun2005CombiningBiometricEvidence}
	Project abacus, smart lock etc. 
	
	multiple cues / multimodal: early work: 
