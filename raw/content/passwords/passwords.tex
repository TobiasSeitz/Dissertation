...
%	Graphics as additional layer \cite{Gao2010ColorLogin} \cite{DeLuca2010ColorPIN}
	...
	%TODO: draw a secret
	Sherman \etal we\cite{Sherman2014UserGeneratedGesturesAuth}
	Gesture puzzle \cite{Schloglhofer2012SecureAndUsableMobileAuth}

	As soon as pattern unlock on Android had become a standard authentication technique, a number of formal evaluations were carried out by the academic community. 
