...
%	Graphics as additional layer \cite{Gao2010ColorLogin} \cite{DeLuca2010ColorPIN}
	...
	Katsini \etal explored mental models and strategies that users employ to create graphical passwords	\cite{Katsini2017StrategiesGraphicalPasswords}.
