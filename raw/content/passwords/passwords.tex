...
%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Stealing / Offline Guessing} Since online attacks are often impractical due to time consumption, offline attacks have prevailed in recent years\footurl{http://breachlevelindex.com/ \label{foot:rw:breachlevelindex}}{20.12.2017}. 
...
Don't forget: Password strength is dynamic! New leaks can render strong passwords very weak. 
	...
	Tell the history of how guesswork was modeled. Starts out with \cite{Weir2009PCFG, Weir2010MetricsPolicies}, then \cite{Kelley20012GuessAgain} and 
