...
%	Graphics as additional layer \cite{Gao2010ColorLogin} \cite{DeLuca2010ColorPIN}
	...
	\subsection{Multilevel, Federated and Token-based Authentication}\label{sec:rw:shared_auth_tokens}
	As a final aspect of authentication beyond passwords, let us take a look at systems that do not try to replace passwords, but make them more user-friendly and/or secure. Single-sign on (SSO) aims to reduce the number of passwords users need to enter by 
