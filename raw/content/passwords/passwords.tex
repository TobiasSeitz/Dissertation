...
%	Graphics as additional layer \cite{Gao2010ColorLogin} \cite{DeLuca2010ColorPIN}
	...
	% critics
	However, De Angeli and Renaud \etal doubt that more visual authentication methods will prevail \cite{DeAngeli2005PictureThousandWords, Renaud2009VisualSnakeOil}. They argue that the promise of more memorable passwords has not been fulfilled by the approaches so far and that we should keep looking elsewhere. 

	\subsection{Biometrics, Multimodal, and Implicit Authentication}
	...
	% implicit features
	gait, keystrokes (with explicit enrollment), 
	...
	Take away: biometric authentication is nice, because it increases usability and reduces interaction times to unlock a system \ar, the weak point appear to be the fallback methods. Moreover, implicit authentication cannot replace explicit prompts, but it can make an existing scheme more secure. 
