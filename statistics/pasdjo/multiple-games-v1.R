...
p
ggsave(plot=p, filename="player-progress-multiplayers.pdf", path="../graphs", width = 8.4, height = 4)
...
embed_fonts("../graphs/v2-player-progress-multiplayers.pdf", outfile="../graphs/v2-player-progress-multiplayers.pdf")
